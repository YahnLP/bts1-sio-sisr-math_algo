...
## 2️⃣ Le diagramme d'état (ou diagramme de phase)
...
### Ligne de référence : pression atmosphérique (1 bar)
...
**Exemple : l'eau à 1 bar**
- T < 0 °C → **glace** (solide)
- 0 °C < T < 100 °C → **eau liquide**
- T > 100 °C → **vapeur** (gaz)
...
**En cosmétique :**
- Chauffage direct d'un récipient métallique contenant une cire
- Spatule qui chauffe au contact d'une plaque

**Facteurs influents :**
- **Conductivité thermique** du matériau (métaux > verre > plastique)
- **Surface de contact**
...
**Mécanisme :**
- Le fluide chaud (moins dense) **monte**
- Le fluide froid (plus dense) **descend**
- Il se crée un **courant de convection**
...
**En cosmétique :**
- **Lampe infrarouge** en cabine esthétique
- **Four IR** pour polymériser un vernis
- **Exposition solaire** (UV → échauffement cutané)
...
### Application en cosmétique : choix du mode de chauffage
...
## 4️⃣ La variabilité statistique (approfondissement de S08)

### Rappel S08 : moyenne et étendue
...
### Application en cosmétique : contrôle de répétabilité
