...
> **Distribution :** En fin de séance de correction, après remise des notes.
> **Usage :** Conservation dans le portfolio — préparation E6 réelle
...
Utilisez votre copie corrigée et ce bilan pour :
1. Identifier vos **points forts** (à mettre en avant lors de l'E6 réelle)
2. Cibler vos **axes de travail** pour l'Année 2
3. Construire votre **stratégie de révision** avant les épreuves
...
## Les 3 Réflexes qui Font la Différence à l'E6
...
## Comment Préparer l'E6 Réelle en Année 2

### Construire son Dossier de Situations Professionnelles
...
### Les Situations Idéales pour l'E6 Bloc 3
...
## Ce qui vous Attend en Année 2 — Bloc 3
...
*Fiche Bilan Post-Examen S20 BLOC 3 — BTS SIO SISR — Année 1 — Version 1.0*
*Compétences couvertes : B3.1 · B3.2 · B3.3 · B3.4*
